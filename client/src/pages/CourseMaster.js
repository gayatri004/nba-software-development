...
function CourseMaster() {
  ...
  const validateForm = () => {
    ...
    if (
      ...
      newErrors.coordinator = "Only alphabets allowed";
    }
    ...
    if (!course.courseOutcome.trim())
      newErrors.courseOutcome =
        "Course Outcome is required";

    if (!course.developmentFees)
      newErrors.developmentFees =
        "Development Fees is required";
